...
import com.resel.ecommerce.config.TwilioConfig;
import com.resel.ecommerce.dto.OtpRequest;
import com.resel.ecommerce.dto.OtpResponseDto;
import com.resel.ecommerce.dto.OtpStatus;
...
public class SmsService {
    ...
    public OtpResponseDto sendSMS(OtpRequest otpRequest) {
        ...
        try {
            ...
            PhoneNumber from = new PhoneNumber(twilioConfig.getFromPhoneNumber()); // from
